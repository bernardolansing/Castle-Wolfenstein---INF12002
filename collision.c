...
bool bau_perto(struct Bau bau)
{
    ...
    Rectangle box_jogador = {player.posx, player.posy, ppl_width, ppl_height};
    Rectangle box_bau = {bau.posx, bau.posy, 45, 45};

    return (CheckCollisionRecs(box_jogador, box_bau));
}

// responde se há porta por perto
...
Rectangle disparobox()
{
    ...
    {
    case 'C':
        box_bullet.x = player.posx + 17;
        box_bullet.y = 0;
        box_bullet.width = 1;
        box_bullet.height = player.posy;
        break;

    case 'B':
        box_bullet.x = player.posx + 17;
        box_bullet.y = player.posy;
        box_bullet.width = 1;
        box_bullet.height = altura - player.posy;
        break;

    case 'D':
        box_bullet.x = player.posx + 11;
        box_bullet.y = player.posy + 24;
        box_bullet.width = largura;
        box_bullet.height = 1;
        break;
    ...
    case 'E':
        box_bullet.x = 0;
        box_bullet.y = player.posy + 24;
        box_bullet.width = player.posx + 17;
        box_bullet.height = 1;
        break;
    }
